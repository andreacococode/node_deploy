...
module.exports = (io) => {
    ...
    router.post('/occupy', (req, res) => {
        ...
        const labAlreadyOccupied = labs.some(lab => lab.utente === utente && lab.stato);

        if (labAlreadyOccupied) {
            return res.status(403).send('Non sei autorizzato a occupare diversi laboratori simultaneamente');
        }
